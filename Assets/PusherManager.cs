...
public class PusherManager : MonoBehaviour
{
    ...
    private const string APP_KEY = "cbb68a6fad0862e7fd60";
    private const string APP_CLUSTER = "ap2";
    ...
    private async Task InitialisePusher()
    {
        ...
        if (_pusher == null && (APP_KEY != "APP_KEY") && (APP_CLUSTER != "APP_CLUSTER"))
        {
            ...
            _channel = await _pusher.SubscribeAsync("notification-show");
    ...
    private void PusherOnConnected(object sender)
    {
        ...
        {
            Debug.Log($"my-event received and data {data}");
        });
    }
